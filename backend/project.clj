(defproject backend "0.1.0-SNAPSHOT"
  ...
  :codox {:metadata {:doc/format :markdown}
          :namespaces [backend.routes.syslog backend.routes.config
                       backend.routes.adaption backend.routes.network
                       backend.routes.core backend.routes.filteredsyslog
                       backend.routes.logadaption backend.routes.util]}
